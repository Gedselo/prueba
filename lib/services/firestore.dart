...
class Servicios {
  ...
  Future<void> addCita(String note, String centro, String estado, bool importante) {
  ...
  Future<void> updateCita(String docID, String note, String centro, String estado, bool importante) {
